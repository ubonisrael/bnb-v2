...
export const notificationSettingsSchema = z.object({
  ...
  emailSettings: z.object({
    ...
    reminderHours: z.coerce.number().min(1, { message: "Must be at least 1 hour" }),
    ...
    followUpDelayHours: z.coerce.number().min(1, { message: "Must be at least 1 hour" }).optional(),
  }),
})
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <div className="mb-6">
          <h2 className="text-lg font-semibold text-[#121212]">Notification Settings</h2>
          <p className="text-sm text-[#6E6E73]">Configure cancellation policies and email notifications</p>
        </div>

        <Card className="border-[#E0E0E5]">
          <CardContent className="pt-6">
            <div className="space-y-4">
              <h3 className="text-md font-medium text-[#121212]">Cancellation Policy</h3>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>How much notice clients need to give to cancel without penalty</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
        ...
        <Card className="border-[#E0E0E5]">
          <CardContent className="pt-6">
            <div className="space-y-4">
              <h3 className="text-md font-medium text-[#121212]">Email Notifications</h3>
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                    <div className="space-y-0.5">
                      ...
                      <FormDescription>Send confirmation emails when clients book appointments</FormDescription>
                    </div>
                    <FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>How many hours before the appointment to send reminders</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                    <div className="space-y-0.5">
                      ...
                      <FormDescription>Send emails when appointments are cancelled</FormDescription>
                    </div>
                    <FormControl>
                      <Switch checked={field.value} onCheckedChange={field.onChange} />
                    </FormControl>
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                    <div className="space-y-0.5">
                      ...
                      <FormDescription>Send emails when clients don't show up for appointments</FormDescription>
                    </div>
                    <FormControl>
                      <Switch checked={field.value} onCheckedChange={field.onChange} />
                    </FormControl>
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                    <div className="space-y-0.5">
                      ...
                      <FormDescription>Send follow-up emails after appointments</FormDescription>
                    </div>
                    <FormControl>
                      <Switch checked={field.value} onCheckedChange={field.onChange} />
                    </FormControl>
              ...
              {form.watch("emailSettings.sendFollowUpEmails") && (
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Follow-Up Delay (Hours After Appointment)</FormLabel>
                      <Select
                        onValueChange={(value) => field.onChange(Number.parseInt(value))}
                      ...
                      <FormDescription>How many hours after the appointment to send follow-up emails</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
