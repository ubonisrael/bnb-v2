...
import { BUSINESS_INFO, REVIEWS, Category } from "@/lib/utils/services";
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                ...
                <p className="mt-3 text-base text-gray-500 dark:text-gray-300 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  Elevate your look with our premium salon and spa services. From haircuts to facials, 
                  our expert stylists and estheticians are here to help you look and feel your best.
                </p>
          ...
          <div className="mt-10">
            <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              ...
              <div className="relative">
                ...
                <dd className="mt-2 ml-16 text-base text-gray-500 dark:text-gray-300">
                  Monday - Friday: {BUSINESS_INFO.hours.monday}<br />
