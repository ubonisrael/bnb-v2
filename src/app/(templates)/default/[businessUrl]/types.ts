...
export const businessData: BusinessData = {
  ...
  bookingPolicy: [
      ...
      "Late cancellations (less than 24 hours) subject to 50% charge",
      ...
      "To reschedule within 24 hours, please contact support directly.",
      "Refunds are processed within 5-7 business days.",
      "No refunds will be issued for missed appointments.",
      "Refunds for dissatisfaction must be requested within 48 hours of the service.",
      "A 30% deposit is required to secure your booking.",
      "Deposits are non-refundable if cancellation is within 24 hours.",
      "Your deposit will be applied toward the total service cost.",
      "Full payment is required at least 12 hours before the appointment.",
      "We accept credit/debit cards, PayPal, and bank transfers.",
      "Failure to complete full payment may result in cancellation of your booking.",
  ],
